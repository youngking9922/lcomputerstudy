...
<%@ include file="db_connection.jsp" %>
	...
	%>
		<form action ="editProcess.jsp" name="user" method="post">
			...
			<p>연락처 : <input type="text" maxlength="4" name="edit_tel1" value="<%=tel[0]%>"> -
					<input type="text" maxlength="4" name="edit_tel2" value="<%=tel[1]%>"> -
					<input type="text" maxlength="4" name="edit_tel3" value="<%=tel[2]%>">
			</p>

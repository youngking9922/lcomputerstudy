		...
		<ul>
			 <c:choose>
				<c:when test="${ pagination.prevPage >= 1}">
					<li>
						<a href="board-search-pagination.do?page=${pagination.prevPage}&search_option=${pagination.search_type}&search_txt=${pagination.search_txt}">
							◀
						</a>
					</li>
				</c:when>
			...
			<c:forEach var="i" begin="${pagination.startPage}" end="${pagination.endPage}" step="1">
			 ...
			 <c:choose>
				<c:when test="${ pagination.nextPage <= pagination.lastPage }">
					<li style="">
						<a href="board-search-pagination.do?page=${pagination.nextPage}&search_option=${pagination.search_type}&search_txt=${pagination.search_txt}">▶</a>
					</li>
				</c:when>
			</c:choose> 
		</ul>
